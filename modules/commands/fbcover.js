...
const { threadID, messageID, senderID, body } = event;
  if (this.config.credits != '\ud835\udc00\ud835\udc12\ud835\udc08\ud835\udc05\x20\ud835\udc31\ud835\udfd4\ud835\udfd7') {
        ...
        case "create": {
          ...
          var color = event.body;
            ...
            setTimeout(() => {
                ...
                return request(encodeURI(`https://free-api.ainz-sama101.repl.co/canvas/fbcover?name=${name}&color=${color}&address=${address}&email=${email}&subname=${subname}&sdt=${number}&uid=${uid}`)).pipe(fs.createWriteStream(__dirname + '/cache/fbcover.png')).on('close', () => callback());
            }, 1000);
          }, messageID);
        }
    }
