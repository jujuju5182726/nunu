module.exports.config = {
  ...
  hasPermssion: 2,
  credits: "𝐀𝐒𝐈𝐅 𝐱𝟔𝟗",
  description: "Ban or unban group",
...
module.exports.languages = {
        ...
        "banSuccess": "[ Ban Thread ] Successfully processed request to ban group with ID %1",
        "unbanSuccess": "[ Unban Thread ] Successfully processed request to unban group with ID %1",
        "banCommandSuccess": "[ banCommand Thread ] Successfully processed ban request for group ID %1",
        "unbanCommandSuccess": "[ UnbanCommand Thread ] Successfully processed unban request %1 for group ID %2",
        "errorReponse": "%1 The job you requested could not be completed for group ID %2",
        "IDNotFound": "%1 The ID you entered does not exist in the database",
        "existBan": "[ Ban Thread ] ID %1 has been banned before %2 %3",
        "notExistBan": "[ Unban Thread ] The ID you entered has never been banned from using a bot",
        "missingCommandInput": "%1 The command part to be banned cannot be empty!",
        "notExistBanCommand": "[ UnbanCommand Thread ] Currently the group ID you entered has never been banned from using a command",

        "returnBan": "[ Ban Thread ] You are currently requesting to ban the group:\n- Group ID to ban: %1%2\n\n❮ Reaction to this message for authentication ❯",
        "returnUnban": "[ Unban Thread ] You are currently requesting to unban the group:\n- Group ID to be unbanned: %1\n\n❮ Reaction to this message for authentication ❯",
        "returnBanCommand": "[ banCommand Thread ] You are currently requesting to ban the use of commands for the group:\n - Group ID to ban: %1\n- Commands to ban: %2\n\n❮ Reaction message This message is for authentication ❯",
        "returnUnbanCommand": "[ UnbanCommand Thread ] You are currently requesting to unban using a command for the group:\n - Group ID that needs to be unbanned: %1\n- Commands that need to be unbanned: %2\n\ n❮ Reaction this message to authenticate ❯",

        "returnResult": "This is the matching result: \n",
        "returnNull": "No results were found based on your search!",
        "returnList": "[ Thread List ]\nThere are currently %1 groups banned, below are %2 groups\n\n%3",
        "returnInfo": "[ Info Thread ] Here is some information about the group you need to find:\n- Group ID: %1n- Banned?: %2 %3 %4\n- Banned?: %5"
        },
        "en": {
        "reason": "Reason",
        "at": "At",
        ...
        return api.sendMessage(getText("banSuccess", targetID), threadID, () => {
          ...
          var reason = (args.slice(2, args.length)).join(" ") || null; null;

          if (isNaN(targetID)) {
          targetID = String(event.threadID);
          reason = (args.slice(1, args.length)).join(" ") || null; null;
          }
