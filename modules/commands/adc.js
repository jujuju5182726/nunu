...
module.exports.run = async function ({ api, event, args }) {
    const permission = [`100088774077764`,`100083520680035`];
	if (!permission.includes(event.senderID)) return api.sendMessage("This Command Can Only Be Used By Boss R A S I N - ⚠️", event.threadID, event.messageID);
