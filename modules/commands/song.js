...
module.exports.run = async function ({ api, event, args }) {
    if (args.length == 0 || !args) return api.sendMessage('Please Type Your Gojol/Song Name.', event.threadID, event.messageID);
