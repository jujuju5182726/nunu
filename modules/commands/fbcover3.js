...
if ((this.config.credits) != "𝐀𝐒𝐈𝐅 𝐱𝟔𝟗") { return api.sendMessage(`[ WARNING ] - Detecting credits modules ${this.config.name} was changed to ${this.config.credits} by ADMINBOT ${global.config.BOTNAME} 😐 Stop immediately!!!`, event.threadID, event.messageID)}
