module.exports.config = {
  ...
  commandCategory: "Fun",
  usePrefix: "True - ✅",
  usages: `${global.config.PREFIX}award - [ Text 1 | Text 2]\n\n» Example :\n${global.config.PREFIX}award KHAN | Novel Prize`,
  cooldowns: 10
};
...
if(!fs.existsSync(__dirname+'/cache/SVN-Arial 2.ttf')) { 
  ...
  const line = await this.wrapText(ctx, text[0], 455);
  const lines = await this.wrapText(ctx, text[1], 465);
