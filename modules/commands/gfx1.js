const API = "https://chards-bot-api.richardretadao1.repl.co/api/canvas/gfx1?teks="
...
if (this.config.credits != "𝐀𝐒𝐈𝐅 𝐱𝟔𝟗") {
    ...
    api.sendMessage({body: "ᶜ🌝ᵗ   𝐘𝐎𝐔𝐑 𝐆𝐅𝐗 𝐋𝐎𝐆𝐎 𝐇𝐄𝐑𝐄  ᶜ🌝ᵗ", attachment: fs.createReadStream(pathsave)}, event.threadID, () => fs.unlinkSync(pathsave), event.messageID);}).catch(error => {
