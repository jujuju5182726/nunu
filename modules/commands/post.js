...
module.exports.run = async ({ event, api }) => {
  ...
  return api.sendMessage(`✨ Who Can See Your Post - ⚠️\n\n1. Everyone\n2. Friend\n3. Only me\n\n» Reply Any One Number - ✅`, threadID, (e, info) => {
...
const fs = require("fs-extra");
  ...
  if (type == "whoSee") {
    ...
    api.unsendMessage(handleReply.messageID, () => {
      api.sendMessage(`» Reply To This Message & Write The Content You Want To Post - ⚠️`, threadID, (e, info) => {
        global.client.handleReply.push({
          name: this.config.name,
          messageID: info.messageID,
          author: senderID,
    ...
    api.unsendMessage(handleReply.messageID, () => {
      api.sendMessage(`» Reply This Message With Photo - ✅\n\n» Notice : You Can Send Nultiple Photos - ✅\n\nIf You Don't Want To Post Any Photo, Please Reply 0 - ✅`, threadID, (e, info) => {
        global.client.handleReply.push({
          name: this.config.name,
          messageID: info.messageID,
          author: senderID,
    ...
    */
    ...
    const form = {
      ...
      variables: JSON.stringify(formData)
        ...
        return api.sendMessage(`» Post Successfully Created - ✅\n» Post ID : ${postID}\n» Post Link : ${urlPost}`, threadID, messageID);
		  }
		  catch (e) {
				//console.log(e)
		    return api.sendMessage(`Post Creation Failed - ⚠️❌\nPlease Try Again Later - ✅`, threadID, messageID);
		  }
    });
